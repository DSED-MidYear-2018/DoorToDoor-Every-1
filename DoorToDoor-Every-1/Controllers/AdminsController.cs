...
namespace DoorToDoor_Every_1.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public AdminsController(DoorContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Email,Password,RememberMe")] Admin admin)
        {
            if (id != admin.Id)
            {
                return NotFound();
